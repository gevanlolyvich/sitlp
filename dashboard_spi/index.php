...
<div class="alert alert-info"><i class="fas fa-calendar"></i>Data Monitoring Audit Tahun <?= date('Y') ?></div>
   ...
   <div class="card-header">
    ...
    <div class="card-body">
     <div class="progress" style="height:30px;">
      <div class="progress-bar bg-success progress-bar-striped progress-bar-animated" style="width: <?= $progress ?>%;"> <?= $progress ?>%</div>
     </div>
    </div>
  </div>
</div>
