...
if(!$data){die("Program Audit tidak ditemukan");}
...
<input type="text" name="kode_program" value="<?= $data['kode_program'] ?>" class="form-control" readonly>
</div>
<div class="col-md-2">
<label>Tahun</label>
...
<input type="text" name="judul_program" value="<?= htmlspecialchars($data['judul_program']) ?>" class="form-control"required>
</div>
<div class="mb-3">
<label>Estimasi Hari</label>
<input type="number" name="estimasi_hari" value="<?= $data['estimasi_hari'] ?>" class="form-control">
</div>
<div class="mb-3">
