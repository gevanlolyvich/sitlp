 ...
 <div class="app-content">
  <div class="container-fluid">
   <div class="card mt-3">
    ...
    <a class="page-link" href="?page=<?= $page - 1 ?>" aria-label="Sebelumnya"><i class="fas fa-chevron-left"></i><span class="d-none d-sm-inline ps-1">Sebelumnya</span></a>
    </li>
    <?php
    $range = [];
    ...
    <a class="page-link" href="?page=<?= $page + 1 ?>" aria-label="Selanjutnya"><span class="d-none d-sm-inline pe-1">Selanjutnya</span><i class="fas fa-chevron-right"></i></a>
    </li>
    </ul>
    </nav>
    </div>
