...
checkRole(['ADMIN', 'KEPALA_SIA', 'AUDITOR', 'DIREKSI']);
            ...
            <div class="row justify-content-center" style="margin-top:60px;">
                <div class="col-md-6 col-lg-5 mb-4">
                    <a href="sia.php" class="text-decoration-none">
                        <div class="card bg-primary text-white text-center py-5 shadow-lg"
                            style="border-radius:16px;cursor:pointer;transition:transform .2s;"
                ...
                <div class="col-md-6 col-lg-5 mb-4">
                    <a href="mr.php" class="text-decoration-none">
                        <div class="card bg-secondary text-white text-center py-5 shadow-lg"
                            style="border-radius:16px;cursor:pointer;transition:transform .2s;"
                            onmouseover="this.style.transform='scale(1.03)'"
                            onmouseout="this.style.transform='scale(1)'">
                            <div class="card-body">
